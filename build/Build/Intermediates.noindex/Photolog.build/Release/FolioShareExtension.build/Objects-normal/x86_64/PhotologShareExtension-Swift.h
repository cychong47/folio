...
#ifndef PHOTOLOGSHAREEXTENSION_SWIFT_H
#define PHOTOLOGSHAREEXTENSION_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PhotologShareExtension",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSBundle;
@class NSCoder;
SWIFT_CLASS("_TtC22PhotologShareExtension19ShareViewController")
