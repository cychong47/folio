...
#ifndef PHOTOLOG_SWIFT_H
#define PHOTOLOG_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Photolog",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
@class NSURL;
SWIFT_CLASS("_TtC8Photolog11AppDelegate")
...
SWIFT_CLASS("_TtC8Photolog14DropTargetView")
