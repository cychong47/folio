...
- **Photo date quick picks** — the Photos-library date range picker shows Recent Posts as a drop-down menu beside Recent Photo Browses, with room for the action buttons, letting users fill the date fields from a known post date or restore a previous browse range
