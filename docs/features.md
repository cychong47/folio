...
- **Event navigator** — sidebar lists each event with its name, capture-local date and time, duration, and selected/total photo count, sorted by the same displayed capture time
