...
- **Photo date quick picks** — the Photos-library date range picker reliably shows compact Recent Posts beside Recent Photo Browses, letting users fill the date fields from a known post date or restore a previous browse range
