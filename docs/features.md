...
- **Photo date quick picks** — the Photos-library date range picker reliably shows compact Recent Posts beside Recent Photo Browses, with room for the action buttons, letting users fill the date fields from a known post date or restore a previous browse range
