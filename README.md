...
- **Photo date quick picks** — the compact Photos-library date range window shows Recent Posts as a drop-down menu beside Recent Photo Browses, so a post date or previous browse range can fill the date fields
