...
- **Photo date quick picks** — the Photos-library date range window reliably shows compact Recent Posts and Recent Photo Browses side by side so a post date or previous browse range can fill the date fields
