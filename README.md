...
- **Photo Curation Workspace** — scan a vacation photo folder (`⌘K`); photos are filtered by capture-local date, auto-grouped into events by time and location, and can create posts in separate editor windows while curation stays open
