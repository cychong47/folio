...
- **Keyboard shortcuts** — `⌘N` New Post or Create Post in curation, `⌘E` Export Photos in curation, `⌘B` Browse Posts, `⌘K` Curate Photos, `⌘S` Save
