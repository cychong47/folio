...
- **EXIF timezone preservation** — photo curation prefers original/base Photos resources, shows selected-event timestamp diagnostics, honors `OffsetTimeOriginal`, `SubSecTimeOriginal`, and inline EXIF timezone offsets, and falls back to Photos' own date for timezone-less library JPEGs
