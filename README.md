...
- **EXIF timezone preservation** — photo curation honors `OffsetTimeOriginal` and inline EXIF timezone offsets, including fractional-second timestamps, so no-GPS photos display in their capture timezone instead of the Mac's current timezone
